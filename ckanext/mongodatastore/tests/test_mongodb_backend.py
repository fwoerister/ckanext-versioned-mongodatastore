...
from ckanext.mongodatastore.datastore_backend import raise_exeption, transform_query_to_statement, \
...
class MongoDbBackendTest(unittest.TestCase):
    ...
    def test_configure(self):
        ...
        with patch.object(VersionedDataStoreController, 'reloadConfig', return_value=None) as mock_method:
            backend.configure({})
