...
import ckan
from ckanext.mongodatastore.controller.ui_controller import history_dump_to, MongoDatastoreController, QueryStoreUIController
...
class QueryStoreControllerTest(unittest.TestCase):
    ...
    def setUp(self):
        self.cntr = QueryStoreUIController()
